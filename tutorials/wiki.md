Welcome to the AMM12-hackathon wiki!

This wiki contains a set of tutorials using the AMM12 configuration:
...
All tutorials are provided with a set of tools that can be found in the [scripts repository](https://github.com/bolb-ocean/AMM12-hackathon/tree/main/SCRIPTS).
